...
@script_exceptions
def bridge_geth(private_key: str, rpc: str, value: float) -> str:
    #Бридж gETH ----> SCROLL
    ...
    if w3.is_connected():
        ...
        logger.info(f'Бриджу {value} gETH в SCROLL')
        ...
        logger.success(f"Transaction: https://goerli.etherscan.io/tx/{w3.to_hex(tx_hash)}")
